...
class Program
{
    static void Main()
    {
        ...
        var authService = new AuthenticationService(inputReader);
        ...
        while (true)
        {
            ...
            Console.WriteLine("13. Azuriraj sve kategorije ako recept sadrzi sastojak");
            ...
            switch (choice)
            {
                ...
                case "12":
                    ...
                    break;
                case "13":
                    UI.AzurirajReceptPoKategorijiISastojkuUI(recipeService, ingredientService);
                    break;
                case "0":
